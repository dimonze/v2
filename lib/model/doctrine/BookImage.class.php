 ...
 * @version    SVN: $Id$
 */
class BookImage extends BaseBookImage
{
  private $_file;
  ...
  {
    return $this->Book->cleanPath($this->getStorage()->getThumb(
      $this->id, 'book_image_medium', array('height' => 470), 'book_image'
    ));
  }
  ...
  public function delete(Doctrine_Connection $conn = null)
  {
    ...
    $this->getStorage()->delete($this->id, 'book_image_medium');
  }
