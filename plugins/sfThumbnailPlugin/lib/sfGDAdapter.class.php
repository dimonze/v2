...
class sfGDAdapter
{
  ...
  public function loadFile($thumbnail, $image, $crop = null)
  {
  ...
  {
    if ($crop = $thumbnail->getCrop($data, $this->sourceWidth, $this->sourceHeight)) {
      $cropped = imagecreatetruecolor($crop['width'], $crop['height']);
      imagecopy($cropped, $this->source, 0, 0, $crop['x'], $crop['y'], $crop['width'], $crop['height']);
      imagedestroy($this->source);
      $this->source = $cropped;list($this->sourceWidth, $this->sourceHeight) = array($crop['width'], $crop['height']);
    }
  }
